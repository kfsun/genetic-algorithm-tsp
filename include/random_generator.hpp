...
//    shared_ptr<boost::variate_generator<boost::mt19937, boost::normal_distribution<>>> pGenerator_;
    std::shared_ptr<boost::variate_generator<boost::mt19937, boost::uniform_real<>>> pGenerator_;
    std::shared_ptr<boost::variate_generator<boost::mt19937, boost::uniform_int<>>> pIntGenerator_;
